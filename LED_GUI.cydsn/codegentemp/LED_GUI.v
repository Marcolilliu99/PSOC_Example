...
module top ;
    ...
    cy_annotation_universal_v1_0 INT_LED (
        .connect({
            Net_1,
            Net_66
        })
    );
    defparam INT_LED.comp_name = "LED_v1_0";
    defparam INT_LED.port_names = "A, K";
    defparam INT_LED.width = 2;

	wire [0:0] tmpOE__PIN_INT_LED_net;
	wire [0:0] tmpFB_0__PIN_INT_LED_net;
	wire [0:0] tmpIO_0__PIN_INT_LED_net;
	wire [0:0] tmpINTERRUPT_0__PIN_INT_LED_net;
	electrical [0:0] tmpSIOVREF__PIN_INT_LED_net;
	...
	cy_psoc3_pins_v1_10
		...
		PIN_INT_LED
		 (.oe(tmpOE__PIN_INT_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_INT_LED_net[0:0]}),
		  .io({tmpIO_0__PIN_INT_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_INT_LED_net),
		  .interrupt({tmpINTERRUPT_0__PIN_INT_LED_net[0:0]}),
		  .annotation({Net_1}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PIN_INT_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    cy_annotation_universal_v1_0 R_LED (
        .connect({
            Net_66,
            Net_6
        })
    );
    defparam R_LED.comp_name = "Resistor_v1_0";
    defparam R_LED.port_names = "T1, T2";
    defparam R_LED.width = 2;
